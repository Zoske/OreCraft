...
public class ItemAdamHat extends ItemArmor implements IArmorTextureProvider {

	public ItemAdamHat(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
		
		super(par1, par2EnumArmorMaterial, par3, par4);
		this.setItemName("adamHat");
